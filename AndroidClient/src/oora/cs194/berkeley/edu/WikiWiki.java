...
public class WikiWiki extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		Object content = null;
		try{
	      URL url = new URL("http://a8.sphotos.ak.fbcdn.net/hphotos-ak-snc4/67479_442596593225_548798225_5621929_2652270_n.jpg");
		...
		try{
	      URL url = new URL("http://s3-media1.ak.yelpcdn.com/bphoto/EhocIif5Ph2zncC3E8e4fQ/l.jpg");
		...
		try{
	      URL url = new URL("http://s3-media4.ak.yelpcdn.com/bphoto/VAqxw4VEe9vtJ-ix12E04Q/l.jpg");
	    ...
	    button1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
			    ...
			    price = price + (Integer.valueOf(edit3.getText().toString()) * 7);
			    price = price + (Integer.parseInt(edit4.getText().toString()) * 5);
			    price = price + (Integer.parseInt(edit5.getText().toString()) * 3);
