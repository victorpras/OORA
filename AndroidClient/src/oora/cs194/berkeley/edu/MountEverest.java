...
public class MountEverest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.everest);
        
        ImageView Image01 = (ImageView) findViewById(R.id.image1);
		Object content = null;
		try{
	      URL url = new URL("http://s3-media3.ak.yelpcdn.com/bphoto/8ofEh6_S-80gFHsyZu8lNA/l.jpg");
		...
		try{
	      URL url = new URL("http://s3-media4.ak.yelpcdn.com/bphoto/sI0UDyxPHn45MIslpvboAQ/l.jpg");
		...
		try{
	      URL url = new URL("http://s3-media1.ak.yelpcdn.com/bphoto/YshY0r7cDNaKOp2moTYW5w/l.jpg");
	    ...
	    button1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
			    ...
			    price = price + (Integer.parseInt(edit4.getText().toString()) * 9);
			    price = price + (Integer.parseInt(edit5.getText().toString()) * 9);
