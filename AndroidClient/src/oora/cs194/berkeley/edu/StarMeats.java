...
public class StarMeats extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.starmeats);
        
        ImageView Image01 = (ImageView) findViewById(R.id.image1);
		Object content = null;
		try{
	      URL url = new URL("http://s3-media4.ak.yelpcdn.com/bphoto/lUyPhakSvhGlEgG--D-Vzg/l.jpg");
		...
		try{
	      URL url = new URL("http://s3-media2.ak.yelpcdn.com/bphoto/lGf56l-Zgh-FNesInoGkmA/l.jpg");
		...
		try{
	      URL url = new URL("http://s3-media3.ak.yelpcdn.com/bphoto/fWsXSz9z55r7QnrNmuF_xA/l.jpg");
	    ...
	    button1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
			    ...
			    price = price + (Integer.parseInt(edit4.getText().toString()) * 8);
			    price = price + (Integer.parseInt(edit5.getText().toString()) * 8);
